    ...
    return (
        ...
        <>
            ...
            <CModal size="xl" visible={visibleXL} onClose={() => setVisibleXL(false)}>
                <CModalHeader style={
                    {
                        backgroundColor: '#232324de', color: '#e99313'
                    }
                }>
                        ...
                        <CCardHeader style={{ backgroundColor: '#232324de', color: '#e99313' }} className=''>
                            <CRow>
                                ...
                                <CCol sm={2} className="d-flex justify-content-end">
                                    <CButton className='text-right bg-white' onClick={addmember} style={{ color: '#e99313', borderColor: '#e99313' }} type="submit">
                                        Add member
                                    </CButton>
                                ...
                                <CTableBody>
                                    {member.map((item, index) => (
                                        <CTableRow v-for="item in tableItems" key={index}>
                                            ...
                                            <CTableDataCell>
                                                <CButton style={{ backgroundColor: '#232324de', color: '#e99313', borderColor: '#e99313' }} onClick={() => { setVisibleXL(!visibleXL); setDegafi(item) }}>
