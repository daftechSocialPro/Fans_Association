      ...
      <CCard className="mb-4">
        ...
        <CCardBody>
          ...
          >
            <CCol md={3}></CCol>
            <CCol md={6}>
               <img style={{ maxHeight: '400px', width: "100%", border: "solid #e99313", borderRadius: "20px" }} src={!img?getImage(news.img):URL.createObjectURL(img)} />
            </CCol>
            <CCol md={3}></CCol>
            ...
            <CCol xs={12} className="d-flex justify-content-end">
              ...
              <CButton size='lg' style={{ backgroundColor: '#232324de', color: '#e99313', borderColor: '#e99313' }} type="submit">
                Update
              </CButton>
            </CCol>
          </CForm>
