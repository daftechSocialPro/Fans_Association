        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            >
              <CCol md={3}></CCol>
              <CCol md={6}>
                {video && <video style={{ maxHeight: '400px', width: "100%", border: "solid #e99313", borderRadius: "20px" }} 
                controls
                >
              ...
              <CCol xs={12} className="d-flex justify-content-end">
                ...
                <CButton style={{ backgroundColor: '#232324de', color: '#e99313', borderColor: '#e99313' }} size="lg" type="submit">
                  Submit
                </CButton>
              </CCol>
            </CForm>
