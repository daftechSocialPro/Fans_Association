                    ...
                    <CCardHeader className='' style={{ backgroundColor: '#232324de', color: '#e99313' }}>
                        <CRow>
                            ...
                            <CCol sm={2} className="d-flex justify-content-end">
                                <CButton className='text-right bg-white' onClick={addVideos} style={{  color: '#e99313', borderColor: '#e99313' }} type="submit">
                                    Add Videos
                                </CButton>
                                    ...
                                    <CCol lg={4} key={item.id}>
                                        <CCard className="mb-3">
                                            ...
                                            <CCardBody>
                                                ...
                                                <CCardLink style={{ color: "#e99313" }} href="#">Edit</CCardLink>
                                                <CCardLink style={{ color: "#e99313" }} href="#">Remove</CCardLink>
